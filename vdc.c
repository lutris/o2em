...
void help(void)
{
    ...
    static char hl[96][70] = { "-wsize=n", " Window size (1-4)", "",
            ...
            "-nosound", " Turn off sound emulation", "", "-novoice",
            " Turn off voice emulation", "", "-svolume=n",
            " Set sound volume (0-100)", "", "-vvolume=n",
            " Set voice volume (0-100)", "", "-filter",
            " Enable low-pass audio filter", "", "-debug",
            " Start the emulator in ", " debug mode", "", "-speed=n",
            " Relative speed", " (100 = original)", "", "-nolimit",
            " Turn off speed limiter", "", "-bios=file",
            " Set the O2 bios file name/dir", "", "-biosdir=path",
            " Set the O2 bios path ", " (default= bios/ )", "", "-romdir=path",
            " Set the O2 roms Path ", " (default= roms/ )", "", "-scshot=file",
            " Set the screenshot file ", " name/template", "", "-euro",
            " Use European timing /", " 50Hz mode", "", "-exrom",
            " Use special 3K program/", " 1K data ROM mode", "", "-3k",
            " Use 3K rom mapping mode", "", "-s<n>=mode/keys",
            " Define stick n mode/keys (n=1-2)", "", "-c52",
            " Start the emulator with ", " french Odyssey 2 BIOS", "", "-g7400",
            " Start the emulator ", " with VP+ BIOS", "", "-jopac",
            " Start the emulator with ", " french VP+ bios", "", "-scoretype=m",
            " Set Scoretype to m (see manual)", "", "-scoreadr=n",
            " Set Scoreaddress to n ", " (decimal value)", "",
            "-scorefile=file", " Set Output-Scorefile to ",
